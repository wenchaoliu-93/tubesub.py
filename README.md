This program fetches the subtitle of a given YouTube video, using an unofficial YouTube API. The YouTube video itself doesn't need to contain all the desired subtitles for this to work.
